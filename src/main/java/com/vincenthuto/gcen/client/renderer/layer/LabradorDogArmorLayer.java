...
public class LabradorDogArmorLayer extends RenderLayer<WolfRenderState, WolfModel> {
    ...
    private final LabradorDogAdultModel adultModel;
    private final EquipmentLayerRenderer equipmentRenderer;

    public LabradorDogArmorLayer(RenderLayerParent<WolfRenderState, WolfModel> renderer, EntityModelSet modelSet, EquipmentLayerRenderer equipmentRenderer) {
        super(renderer);
        this.adultModel = new LabradorDogAdultModel(modelSet.bakeLayer(LabradorDogAdultModel.ARMOR_LAYER_LOCATION));
