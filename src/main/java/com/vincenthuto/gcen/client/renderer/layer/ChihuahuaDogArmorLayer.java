...
public class ChihuahuaDogArmorLayer extends RenderLayer<WolfRenderState, WolfModel> {
    ...
    private final ChihuahuaDogAdultModel adultModel;
    private final EquipmentLayerRenderer equipmentRenderer;

    public ChihuahuaDogArmorLayer(RenderLayerParent<WolfRenderState, WolfModel> renderer, EntityModelSet modelSet, EquipmentLayerRenderer equipmentRenderer) {
        super(renderer);
        this.adultModel = new ChihuahuaDogAdultModel(modelSet.bakeLayer(ChihuahuaDogAdultModel.ARMOR_LAYER_LOCATION));
    ...
    private void maybeRenderCracks(
        ...
        if (crackiness != Crackiness.Level.NONE) {
            ...
            submitNodeCollector.submitModel(
                    ...
                    state,
                    poseStack,
                    RenderTypes.armorTranslucent(damageTexture),
                    lightCoords,
